...
#include "events/mprotect.c"
#include "events/ptrace.c"
#include "events/proc_vm_write.c"
#include "events/memfd_create.c"
#include "events/kernel/kmalloc.c"
#include "events/kernel/kvmalloc.c"
#include "events/kernel/vmalloc.c"
#include "events/kernel/kmalloc_order_trace.c"
#include "events/kernel/get_pci_device.c"
#include "events/kernel/kmem_cache_alloc_trace.c"
#include "events/kernel/kmem_cache_create.c"


MODULE_DESCRIPTION("Main module for memfini");
...
#define SYSCALL_NAME2(name) (name)
...
// hook for kernel funtions
#define HOOK2(_name, _function, _original)	\
	{					\
		.name = SYSCALL_NAME2(_name),	\
		.function = (_function),	\
		.original = (_original),	\
	}
static struct ftrace_hook demo_hooks[] = {
	...
	HOOK2("vmalloc", fh_vmalloc, &real_vmalloc),
	HOOK2("kmalloc_order_trace", fh_kmalloc_order_trace, &real_kmalloc_order_trace),
	// unstable
	//HOOK2("kmem_cache_alloc_trace", fh_kmem_cache_alloc_trace, &real_kmem_cache_alloc_trace),
	HOOK2("kmem_cache_create", fh_kmem_cache_create, &real_kmem_cache_create),
	HOOK2("pci_get_device",  fh_pci_get_device,  &real_pci_get_device),
#endif
};
